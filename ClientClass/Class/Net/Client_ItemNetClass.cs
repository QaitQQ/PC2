...
namespace Client.Class.Net
{
    ...
    public class ItemNetClass
    {
        ...
        public List<СomparisonNameID> Retun_Item_List(int ItemFild = 0) => (List<СomparisonNameID>)new TCP_Client_GetObj(ItemSelector).Get(SecondSelector.EnumItem.ItemsSearch, new object[] { _SendObj, ItemFild });
