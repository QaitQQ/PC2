...
//        public bool NewPartner() => (bool)new TCP_Client_GetObj(_FirstSelector).Get(EnumCrmNetClass.NewPartner);
//        public bool DelPartner() => (bool)new TCP_Client_GetObj(_FirstSelector).Get(EnumCrmNetClass.DelPartner);
//        public bool NewEvent() => (bool)new TCP_Client_GetObj(_FirstSelector).Get(EnumCrmNetClass.NewEvent);
//        public bool DelEvent() => (bool)new TCP_Client_GetObj(_FirstSelector).Get(EnumCrmNetClass.DelEvent);
