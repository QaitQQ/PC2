...
//        private List<СomparisonNameID> _SearchList;
//        #endregion
//        public ItemForm()
//        {
//            InitializeComponent();
...
//            _FillTable = FillTable.СhangedItemsTableSelected;
//        }
...
//            foreach (СomparisonNameID item in _SearchList)
//            { SearchList.Items.Add(item.Name.Replace(@"\n", "").Trim()); }
//        }
...
//                int ID = _SearchList.Find(x => x.Name.Trim() == Name).Id;
//                SearchFill(ID);
...
//                if (Coordinate.ToString() == "Принять" &&(_FillTable == FillTable.СhangedItemsTable || _FillTable == FillTable.СhangedItemsTableSelected)) { UpdateMappedPosition(e); }
//                if (Coordinate.ToString() == "Принять" && _FillTable == FillTable.СhangedItemsTableSelected)
...
//                    Task.Factory.StartNew(() => new ItemNetClass().Del_Item_From_СhangeList(obj));
//                    MainFieldTable.Rows[e.RowIndex].Visible = false;
//                }
//                if (Coordinate.ToString() == "Принять все")
//                {
//                    if (_FillTable == FillTable.СhangedItemsTableSelected)
//                    {
//                        List<string> List = new List<string>();
//                        foreach (DataGridViewRow item in MainFieldTable.Rows)
//                        {
//                            List.Add(item.Cells[0].Value?.ToString());
//                        }
//                        Task.Factory.StartNew(() => new ItemNetClass().AllowAll(_FillTable, List));
//                    }
//                    else
//                    {
//                        new ItemNetClass().AllowAll(_FillTable);
//                    }
//                }
//            }
//        }
...
//            {
//                var str = MainFieldTable.Rows[e.RowIndex].Cells[i].Value.ToString();
//                if (str.Contains('>'))
//                {
//                     str = str.Split('>')[1];
//                }
...
//            Obj.Item.PriceRC = converter(2);
//            Obj.Item.PriceDC = converter(3);
