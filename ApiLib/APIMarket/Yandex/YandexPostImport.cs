...
namespace SiteApi.IntegrationSiteApi.APIMarket.Yandex.YandexPostImport
{
    public class YandexPostImport : SiteApi.IntegrationSiteApi.APIMarket.Yandex.YandexApiClass
    {
        ...
        {
            HttpWebRequest httpWebRequest = GetRequest(@"/campaigns/" + ClientID + "/offer-mapping-entries/updates.json", "POST");
    ...
    internal class Offer
    {
        public Offer(IMarketItem item)
        {
            ...
            {
                Server.Class.IntegrationSiteApi.Market.Yandex.YandexGetName.YandexGetItemList.ItemYandex X = (Server.Class.IntegrationSiteApi.Market.Yandex.YandexGetName.YandexGetItemList.ItemYandex)item;
