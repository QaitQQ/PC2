...
{
    public abstract class OzonPost : MarketApi
    {
        internal string ClientID;
        internal string apiKey;
        internal string result;
        public OzonPost(string ClientID, string apiKey) { this.ClientID = ClientID; this.apiKey = apiKey; }
    ...
    [Serializable]
        ...
        [Serializable]
        public class Item_D: IMarketItem
    {
        ...
        {
            public List<Item_D> items { get; set; }
        }
        [Serializable]
        public class Root_D
        {
