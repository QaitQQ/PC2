...
namespace Server.Class.IntegrationSiteApi.Market.Yandex.YandexGetItemOrders
{
    public class YandexGetItemOrders : SiteApi.IntegrationSiteApi.APIMarket.Yandex.YandexApiClass
    {
        ...
        public List<object> Get()
        {
            ...
            var httpWebRequest = GetRequest(@"/campaigns/" + ClientID + "/orders.json", "GET");
        ...
        public class Order: IOrder
        {
            ...
            public string Date { get { return CreationDate; } }

            public string DeliveryDate { get { return DateTime.Parse(Delivery.Shipments[0].ShipmentDate).ToShortDateString(); } }
