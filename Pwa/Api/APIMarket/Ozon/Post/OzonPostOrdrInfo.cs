...
{
    public class OzonPostOrdrInfo : OzonPost
    {
        ...
        {
            HttpWebRequest httpWebRequest = GetRequest(@"v3/posting/fbs/get");
            PostQwery root = new PostQwery(postingNumber) { };
            ...
            try
            {
                ...
                if (result != null)
                {
                    ...
                    OrderList!.Result!.APISetting = aPISetting != null ? aPISetting : new APISetting();
